...
<div className="sm:hidden flex items-center justify-center h-screen bg-[#12141A] text-gray-300 p-6 text-center">
  <p>CodeX works best on a larger screen. Please switch to a tablet or desktop for the full coding experience.</p>
</div>
<div className="hidden sm:flex h-screen bg-[#12141A] text-gray-200">      <ActivityBar />
