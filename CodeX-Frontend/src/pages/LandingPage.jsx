  ...
  return (
    <div className="min-h-screen bg-[#12141A] text-gray-200 overflow-hidden">
      ...
      <section className="relative px-4 py-16 sm:py-24 overflow-hidden">
        ...
        <div
          className="absolute top-32 right-1/4 w-72 h-72 bg-teal-500/10 rounded-full blur-3xl animate-float pointer-events-none"
        ...
        <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left animate-fadeInUp">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="text-gray-100">Don't just</span>
              <br />
              <span className="text-amber-400">read code —</span>
              <br />
              <span
                className="relative inline-block bg-clip-text text-transparent animate-shimmer"
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, #2dd4bf, #5eead4, #2dd4bf, #5eead4)",
            ...
            <p className="text-gray-400 max-w-xl mx-auto lg:mx-0 mb-8">
              ...
              you explain your code to the AI. It listens, evaluates, and helps
              you truly understand.
            </p>
            <MagneticButton
              to="/signup"
              className="inline-block text-black font-semibold px-8 py-3 rounded-full shadow-lg shadow-amber-400/40 hover:scale-105 transition-transform duration-300"
            >
              🚀 Start Teaching Now
            </MagneticButton>
      ...
      {/* Language marquee */}
      <div className="border-y border-gray-800 bg-[#0d0e12] py-4 overflow-hidden">
        <div className="flex animate-marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div
              key={i}
              className="flex gap-12 px-6 text-sm text-gray-500 shrink-0"
            >
      ...
      <section
        id="how-it-works"
        className="bg-[#181a21] py-16 px-4 text-center"
      >
        <Reveal>
          ...
          {[
            {
              step: "1",
              title: "Write code",
              desc: "Solve a problem and write your code in the editor.",
            },
            {
              step: "2",
              title: "Explain it",
              desc: "Teach the AI what your code does, step by step.",
            },
            {
              step: "3",
              title: "AI evaluates",
              desc: "Our AI checks your explanation and fills the gaps.",
            },
            {
              step: "4",
              title: "Track progress",
              desc: "See your growth over time. Get better, faster.",
            },
          ].map((item, i) => (
      ...
      <section id="features" className="py-16 px-4 text-center">
        <Reveal>
          <h2 className="text-3xl font-semibold mb-10">
            Built for <span className="text-teal-400">deeper</span>{" "}
            understanding
          </h2>
        </Reveal>
          ...
          {[
            {
              ...
              desc: "Get instant, AI-powered feedback on how well you explain your code.",
              color: "teal",
            },
            {
              title: "Concept Mastery",
              desc: "Identify weak concepts, review smarter, and lock in real understanding.",
              color: "amber",
            },
            {
              title: "Progress Tracking",
              desc: "Visualize your improvement with session stats and insights.",
              color: "amber",
            },
            {
              title: "Works with your workflow",
              desc: "Use any language, any editor. We fit right into how you code.",
              color: "teal",
            },
          ].map((f, i) => (
            <Reveal key={f.title} delay={i * 100}>
              ...
              >
                <h3
                  className={`font-semibold mb-2 ${f.color === "teal" ? "text-teal-400" : "text-amber-400"}`}
                >
                  {f.title}
                </h3>
